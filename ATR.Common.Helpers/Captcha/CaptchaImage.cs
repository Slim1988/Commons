namespace CaptchaDotNet2
{
    ...
    public class CaptchaImage
    {
        ...
        private void GenerateImage()
        {
            ...
            using (SolidBrush b = new SolidBrush(this.bc))
            {
                g.FillRectangle(b, rect);
            }

            // Set up the text font.
            int emSize = this.width * 2 / this.text.Length;
            FontFamily family = this.fonts[RNG.Next(this.fonts.Length - 1)];
            ...
            while ((emSize > 2 && (measured = g.MeasureString(this.text, font)).Width > workingSize.Width) || measured.Height > workingSize.Height)
            {
                font.Dispose();
            ...
            int bcR = Convert.ToInt32(this.bc.R);

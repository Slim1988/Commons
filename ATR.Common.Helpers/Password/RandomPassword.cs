namespace ATR.Common.Helper.Password
{
    using System;
    ...
    {
        /// <summary>
        /// The default password min length value
        /// </summary>
        private static int defaultMinPasswordLength = 10;

        /// <summary>
        /// The default password max length value
        /// </summary>
        private static int defaultMaxPasswordLength = 12;

        /// <summary>
        /// The password chars in low case
        /// </summary>
        private static string passwordCharsLowCase = "abcdefghijkmnpqrstwxyz";

        /// <summary>
        /// The password chars in up case
        /// </summary>
        private static string passwordCharsUpCase = "ABCDEFGHJKLMNPQRSTWXYZ";

        /// <summary>
        /// The password chars numerics
        /// </summary>
        private static string passwordCharsNumerics = "23456789";

        /// <summary>
        /// The password chars specials
        /// </summary>
        private static string passwordCharsSpecials = @"!#$%&*+=(){}[]:;,.?/";
        ...
        public static string Generate(int minLength, int maxLength)
        {
            ...
            {
                passwordCharsLowCase.ToCharArray(),
                passwordCharsUpCase.ToCharArray(),
                passwordCharsNumerics.ToCharArray(),
                passwordCharsSpecials.ToCharArray()
            };
            ...
            // Because we cannot use the default randomizer, which is based on the current time (it will produce the same "random" number within a second),
            // we will use a random number generator to seed the randomizer.
            ...
            for (int i = 0; i < password.Length; i++)
            {
                ...
                // otherwise, pick a random character group from the unprocessed group list. To allow a special character to appear in the
                // first position, increment the second parameter of the Next function call by one, i.e. lastLeftGroupsOrderIdx + 1.
